export const i18n = {
  zh: {
    ...
    upload_root_readonly_hint: '该目录来自 Docker 挂载配置。如需改到完全不同的宿主机目录，需要修改 .env 的 WEB_AUTO_HOST_DATA_ROOT 并重建容器。',
    upload_target_hint: '项目页上传数据集默认写入此目录。该目录必须位于服务器可写数据根目录下。',
  ...
  en: {
    ...
    upload_root_readonly_hint: 'This directory comes from the Docker mount. To move outside it, update WEB_AUTO_HOST_DATA_ROOT in .env and recreate the container.',
    upload_target_hint: 'Dataset uploads use this as the default target. It must be inside the writable data root.',

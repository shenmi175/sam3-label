...
"""Compatibility tests for sam3.model.io_utils video frame loading.

Migrated from upstream test/test_io_utils.py (extensionless video file handling,
D99228861) into the platform test suite. Skips entirely when the pinned sam3
...
pytestmark = pytest.mark.skipif(
    not SAM3_AVAILABLE, reason="sam3 package not installed"
)
